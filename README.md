...
- `--no_disclosure`:
  ...
  An epub output is marked as an AI translation by default; this flag leaves the marking out. It also turns off the translation metadata (`--translation-metadata`).
